...
unsigned long myChannelNumber = 1123440;
const char * myWriteAPIKey = "1*******D";

const char* ssid = "Neej";   // your network SSID (name) 
const char* password = "Tp@010601";   // your network password

// Your Domain name with URL path or IP address with path
String openWeatherMapApiKey = "4***********9";
String city = "Haryana";
...
void loop() {
  ...
  if ((millis() - lastTime) > timerDelay) {
   ...
   tempThings=tempThings-273; //the temp will be in Kelvin which re recieved so we are converting the same to celcius.
   ...
   int windspeedThings=windspeed;
      ...
      // below commets lines is for checking the data in serial monitor parallaly.
